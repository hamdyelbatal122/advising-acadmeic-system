         ...
         <div class="history-content">
            ...
            <div class="row row-cols-1 row-cols-md-3">
               <div class="col">
                  <h3>Origin</h3>
                  <p>
                     CIS, short for Cairo International School, is a prominent educational institution located in Egypt. Renowned for its commitment to academic excellence and holistic development, CIS offers a diverse range of educational programs catering to students from various cultural backgrounds </p>
               </div>
               <div class="col">
                  <h3>Campus</h3>
                  <p> 
