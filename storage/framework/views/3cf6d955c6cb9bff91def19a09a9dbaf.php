                     ...
                     <ul class="dropdown-menu">
                        <li class="user-body">
                           <div class="col-xs-6 text-center">
                              <a href="<?php echo e(route('student.profile.index')); ?>">
                                 <div><i class="fa fa-briefcase"></i></div>
                                 Profile 
                              </a>
                           </div>
                           <div class="col-xs-6 text-center">
                              <a href="<?php echo e(route('student.profile.password')); ?>">
            ...
            <section class="sidebar">
               ...
               <div class="user-panel">
                  ...
                  <div class="pull-left info">
                     <p><?php echo e($student->first_name . ' ' . $student->last_name); ?></p>
               ...
               <ul class="sidebar-menu">
                  <li <?php echo e(Request::is('dashboard') ? 'class=active' : ''); ?>><a href="<?php echo e(route('student.home')); ?>"><i class="fa fa-laptop"></i><span>Dashboard</span> </a></li>

                  <li <?php echo e(Request::is('*/courses/*') && !Request::is('*/courses/routine*') && !Request::is('*/courses/exams*') ? 'class=active' : ''); ?>><a href="<?php echo e(route('student.courses.index')); ?>"><i class="fa icon-subject"></i><span>My Course</span> </a></li>
...
</html><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/student/layouts/app.blade.php ENDPATH**/ ?>