...
<?php $__env->startSection('title', $student->id.' - '.$student->first_name.' '.$student->last_name); ?>
                                 ...
                                 <table class="table table-bordered table-sm">
                                    ...
                                    <tbody align="center" style="padding-top: 10px">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <?php if($course->lab): ?>
                                             <p><strong>Day:</strong> <?php echo e($course->day_of_lab); ?></p>
                                    ...
                                    <div id="mCSB_1_container" class="mCSB_container mCS_x_hidden mCS_no_scrollbar_x" style="position: relative; top: 0px; left: 0px; width: 100%;" dir="ltr">
                                       <table class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                             <?php
                                             $myGrades = 0;
                                             $count = $advising->marks->count();
                                             $total_gpa_in_marks = 0;
                                             ?>
                                             <?php $__currentLoopData = $advising->marks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <?php
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/admin/students/view.blade.php ENDPATH**/ ?>