...
$.ajax({
  ...
  url: "<?php echo e(route('admin.marks.store')); ?>",
  ...
  error: function(response){
   ...
   $('#student_id').on('change', function() {
    ...
    $.ajax({
      url: "<?php echo e(route('admin.marks.student.data')); ?>",
      type: "GET",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/admin/marks/create.blade.php ENDPATH**/ ?>