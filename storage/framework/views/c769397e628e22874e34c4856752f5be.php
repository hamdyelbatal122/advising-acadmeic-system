         ...
         <div class="col-xs-12">
            <div class="box">
               <div class="box-header">
                  ...
                  <ol class="breadcrumb">
                     <li><a href="<?php echo e(route('student.home')); ?>"><i class="fa fa-laptop"></i>
                        Dashboard</a>
                     </li>
...
url: "<?php echo e(route('students.password.update')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.student.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/student/profile/password.blade.php ENDPATH**/ ?>