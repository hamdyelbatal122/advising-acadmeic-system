                                       ...
                                       <tbody>
                                          ...
                                          <tr id="id-<?php echo e($notice->id); ?>">
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <a class="btn btn-success btn-sm" href="<?php echo e(route('admin.notices.show', $notice->id)); ?>"><i class="fa fa-eye"></i></a>
                                                <a class="btn btn-danger btn-sm" onclick="deleteRow(<?php echo e($notice->id); ?>)"><i class="fa fa-trash"></i></a>
                                             </td>
                                          </tr>
...
<script type="text/javascript">
   ...
   url: "<?php echo e(route('admin.notices.delete')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/admin/notices/index.blade.php ENDPATH**/ ?>