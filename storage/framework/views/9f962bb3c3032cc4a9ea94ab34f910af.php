   ...
   <!--=====================================
    ...
    <form class="login-form" method="post" action="<?php echo e(route('admin.login.post')); ?>"> 
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.admin.layouts.app-auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/admin/auth/login.blade.php ENDPATH**/ ?>