            ...
            <div class="well">
               <div class="row">
                  <div class="col-sm-6">
                     ...
                     <a href="<?php echo e(route('student.notices.reply',$notice->id)); ?>" class="btn-cs btn-sm-cs" style="text-decoration: none;" role="button"><i class="fa fa-edit"></i> reply</a>
                     <?php else: ?>
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo e(route('student.notices.index')); ?>">Notice</a></li>
                  ...
                  <div id="printablediv" class="box-body">
                     <div class="row">
                        <div class="col-sm-12">
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 <h5><strong style="color:<?php if($reply->admin_id): ?>red; <?php else: ?> blue; <?php endif; ?>"><?php if($reply->admin_id): ?> Reply From Admin : <?php else: ?>  Reply From You <?php endif; ?></strong></h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.student.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/student/notices/show.blade.php ENDPATH**/ ?>