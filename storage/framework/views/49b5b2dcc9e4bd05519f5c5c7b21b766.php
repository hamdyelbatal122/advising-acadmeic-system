...
<html lang="en">
   <head>
      ...
      <!-- FONTS -->
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/iconly/iconly.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/lineicons/css/icons.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/fontawesome/css/all.css')); ?>" >
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/timesnew.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/opensans.css')); ?>">
      <!-- LIBRARY -->
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/venobox/all.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/carousel/owl.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/carousel/owl.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap-site.min.css')); ?>">
   ...
   <body>
            ...
            <div class="header-content">
               ...
               <nav class="header-nav">
                  ...
                  <ul class="header-nav-list">
                     <li
                        class="header-nav-item <?php echo e(Request::is('/') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.home')); ?>"
                           class="header-nav-link">Home</a>
                     </li>
                     <li
                        class="header-nav-item <?php echo e(Request::is('*about') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.about')); ?>"
                           class="header-nav-link">About</a>
                     </li>
                     <li
                        class="header-nav-item <?php echo e(Request::is('*professors') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.professors')); ?>"
                           class="header-nav-link ">Professors</a>
                     </li>
                     <li
                        class="header-nav-item  <?php echo e(Request::is('*events') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.events')); ?>"
                           class="header-nav-link">Events</a>
                     </li>
                     <li
                        class="header-nav-item <?php echo e(Request::is('*gallery') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.gallery')); ?>"
                           class="header-nav-link">Gallery</a>
                     </li>
                     <li
                        class="header-nav-item <?php echo e(Request::is('*blog') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.blog')); ?>"
                           class="header-nav-link">Blog</a>
                     </li>
                     <li
                        class="header-nav-item <?php echo e(Request::is('*contact') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.contact')); ?>"
                           class="header-nav-link">Contact</a>
                     </li>
                     <li
                        class="header-nav-item <?php echo e(Request::is('*advising') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('site.advising')); ?>"
                           class="header-nav-link">Advising</a>
                     </li>
                  </ul>
               </nav>
               <a href="<?php echo e(route('student.login')); ?>" class="header-action-btn"
                  style="-webkit-mask-image: url('<?php echo e(asset('assets/images/site/badge.png')); ?>');" >
               <img src="<?php echo e(asset('assets/images/site/icon.png')); ?>" alt="icon">
               <span> login </span>
               </a>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-12 col-sm-12 col-md-5">
                  <div class="footer-about">
                     <p> CIS International University  is a fully accredited, independent, international University in New Cairo, Egypt. </p>
                     <ul>
                        <li>
                           ...
                           <span>
                           Gamal Abd El Naser ,5th Settlement, New Cairo, Egypt
                           </span>
                        </li>
                        <li>
                           <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
               ...
               <div class="col-12 col-sm-6 col-md-3">
                  <nav class="footer-navs">
                     ...
                     <a href="<?php echo e(route('site.contact')); ?>">Contact Us </a>
                     <a href="<?php echo e(route('site.advising')); ?>">Advising</a>
                     <a href="<?php echo e(route('site.blog')); ?>">Blog</a>
                  </nav>
               </div>
      ...
      <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery-site.min.js')); ?>"></script>
      <script defer src="<?php echo e(asset('assets/js/carousel/owl.min.js')); ?>"></script>
      <script defer src="<?php echo e(asset('assets/js/carousel/initialize.js')); ?>"></script>
      <script defer src="<?php echo e(asset('assets/js/venobox/all.min.js')); ?>"></script>
      <script defer src="<?php echo e(asset('assets/js/venobox/initialize.js')); ?>"></script>
      <script defer src="<?php echo e(asset('assets/js/bootstrap.min.js')); ?>"></script>
      <script defer src="<?php echo e(asset('assets/js/script.js')); ?>"></script>

   </body>
</html><?php /**PATH E:\xampp\htdocs\ac\resources\views/site/layouts/main.blade.php ENDPATH**/ ?>