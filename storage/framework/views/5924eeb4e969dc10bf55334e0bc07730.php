                                    ...
                                    <table id="myTable" class="display" style="width:100%">
                                       ...
                                       <tbody>
                                          ...
                                          <tr id="id-<?php echo e($course->id); ?>">
                                             ...
                                             <td><?php echo e($course->professor->name); ?></td>
                                             <td><?php echo e($course->hours); ?></td>
                                             <td>
                                                <a class="btn btn-success btn-sm" href="<?php echo e(route('admin.courses.edit', $course->id)); ?>"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm" onclick="deleteRow(<?php echo e($course->id); ?>)"><i class="fa fa-trash"></i></a>
                                             </td>
                                          </tr>
...
<script type="text/javascript">
   ...
   url: "<?php echo e(route('admin.courses.delete')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/admin/courses/index.blade.php ENDPATH**/ ?>