                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <h5 class="page-header">
                           <a href="<?php echo e(route('admin.marks.create')); ?>">
                                    ...
                                    <table id="myTable" class="display" style="width:100%">
                                       ...
                                       <tbody>
                                          ...
                                          <tr id="id-<?php echo e($advising->id); ?>">
                                             ...
                                             <td><?php echo e($advising->semester); ?></td>
                                             <td><?php echo e($advising->admin->name); ?></td>
                                             <td><?php echo e($advising->admin->name); ?></td>

                                             <td>
                                                <a class="btn btn-info btn-sm" href="<?php echo e(route('admin.marks.show', $advising->id)); ?>" target="_blank" ><i class="fa fa-eye"></i></a>
                                                <a class="btn btn-success btn-sm" href="<?php echo e(route('admin.marks.edit', $advising->id)); ?>"><i class="fa fa-edit"></i></a>
                                             </td>
                                          </tr>
...
<script type="text/javascript">
   ...
   $('#level_id').on('change', function() {
    ...
    return window.location.href = "<?php echo e(route('admin.marks.index')); ?>/" + level_id;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ac\resources\views/dashboard/admin/marks/index.blade.php ENDPATH**/ ?>