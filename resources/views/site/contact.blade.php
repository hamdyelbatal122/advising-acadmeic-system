        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6">
                    ...
                    <p class="contact-describe"><p>Explore our thriving institution, dedicated to fostering excellence in education and innovation</p></p>
                    <div class="contact-content">
                        <ul>
                            <li>
                                ...
                                <span>Gamal Abd El Naser ,5th Settlement, New Cairo, Egypt</span>
                            </li>
                            <li>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                ...
                                <span>info@cis.edu.eg </span>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-lg-6">  
                    <iframe class="contact-map" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13821.963978899215!2d31.434457000000002!3d29.994055000000003!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583cb080ef5685%3A0x1a58ed16c4fac2b!2z2KfZg9in2K_ZitmF2YrYqSDYp9mE2YLYp9mH2LHYqSDYp9mE2KzYr9mK2K_YqQ!5e0!3m2!1sar!2seg!4v1714857841550!5m2!1sar!2seg"  style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="subject" name="sub" placeholder="Enter your subject">
                            </div>
                        </div>
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                <label for="message" class="form-label">Message</label>
                                <textarea name="message" class="form-control" id="message" placeholder="Enter your message" rows="5"></textarea>
