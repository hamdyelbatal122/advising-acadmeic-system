            ...
            <div class="well">
               <div class="row">
                  <div class="col-sm-6">
                     ...
                     <a href="{{route('admin.notices.reply',$notice->id)}}" class="btn-cs btn-sm-cs" style="text-decoration: none;" role="button"><i class="fa fa-edit"></i> reply</a>
                     @else
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="{{route('admin.notices.index')}}">Notice</a></li>
                  ...
                  <div id="printablediv" class="box-body">
                     <div class="row">
                        <div class="col-sm-12">
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 <h5><strong style="color:@if($reply->admin_id)red; @else blue; @endif">@if($reply->admin_id) Reply From Admin : @else  Reply From Student @endif</strong></h5>
                                 <p >{!!$reply->message!!}</p>
