...
@section('title', $student->id.' - '.$student->first_name.' '.$student->last_name)
@section('content')
                              ...
                              <div class="row">
                                 ...
                                 <div class="profile-view-tab">
                                    <p><span>Currant Advising </span>: 
                                       @if($activeAdvising)
                                       <a href="{{route('admin.advising.show',$activeAdvising->id)}}"> 
                                    ...
                                    <div style="position: relative; top: 0px; left: 0px; width: 100%;" dir="ltr">
                                       <table class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                             ...
                                             @endphp
                                             @foreach($advising->marks as $course)
                                             @php
                              ...
                              <table class="table table-striped table-bordered table-hover">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>
                                          <a href="{{route('admin.students.print',$student->id)}}" >
                                          <button class="btn-cs btn-sm-cs">view</button>
                                          </a>
                                       </td>
                                    </tr>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <a href="{{route('admin.advising.show',$advising->id)}}" >
                                          <button class="btn-cs btn-sm-cs">view</button>
                                          </a>
                                       </td>
                                    </tr>
